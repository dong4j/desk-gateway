...
ESP-IDF project for the standing-desk gateway. Parent docs: [../../README.md](../../README.md) · [中文](../../README.zh-CN.md). How to move the desk from Web, REST, BLE, phone, Watch, keyboard, voice, D200H, or LAN MQTT: [control methods](../../docs/guides/control-methods.md). Home Assistant: [HA MQTT guide](../../docs/guides/home-assistant-mqtt.en.md). REST contract: [REST API](../../docs/guides/rest-api.md).
