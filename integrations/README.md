...
Third-party clients. Most reuse the same LAN REST surface as Web and `scripts/desk-preset.sh`. Home Assistant uses LAN MQTT Discovery instead. None of them call a vendor I²C driver. Motion still goes through `desk_core` (STOP, child-lock, source ACL, ToF).
...
|---|---|---|
| [home-assistant](home-assistant/README.md) | LAN MQTT Discovery; no custom integration | Cover sit / stand / stop |
...
Matter, Xiaomi, and Huawei remain design docs only. See [`docs/future/ecosystem-xiaomi-huawei.md`](../docs/future/ecosystem-xiaomi-huawei.md). The HA MQTT topic contract is still [`docs/future/mqtt-home-assistant.md`](../docs/future/mqtt-home-assistant.md); the how-to is [`docs/guides/home-assistant-mqtt.en.md`](../docs/guides/home-assistant-mqtt.en.md).
